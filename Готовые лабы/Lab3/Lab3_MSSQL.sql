...
SELECT * FROM Cars;
--2.—оздать процедуру, котора€ отобразит все подчиненные узлы с указанием уровн€ иерархии 
--(параметр Ц значение узла).
...
EXEC AddNode 
    ...
    @Rental_Price = 90.00,
    @Location = 'г.ћинск, ул. ѕримерна€, д.2';
...
--4.—оздать процедуру, котора€ переместит всю подчиненную ветку (первый параметр Ц значение 
--верхнего перемещаемого узла, второй параметр Ц значение узла, в который происходит перемещение).
